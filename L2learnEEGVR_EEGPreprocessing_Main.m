...
[EEG,com,b] = pop_firws(EEG,'fcutoff',[f_low f_hi],'forder',M,'ftype','bandpass','wtype','kaiser');
...
CREx_SpectCalc_multitap(EEG,[67 69],[1 60],specnom_ref,.1);
...
%% Segmentation of Exp1 and Exp2 data.
